...
import KevinData from "./teamB/kevin.mjs";


import SilfanusData from "./teamB/Silfanus.mjs";
...
import otipaData from "./teamB/otipa.mjs";
import ligalaData from "./teamB/ligalah.mjs";
import AmianiData from "./teamA/Amiani.mjs";

const data = [davidData, someoneData,AmianiData,ligalaData,SebbieData, CalvinData,david1Data,otipaData,amos1data,SilfanusData,nevilleData,KevinData]
